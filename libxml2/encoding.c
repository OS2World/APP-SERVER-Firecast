 ...
 */
static int
_isolat1ToUTF8(unsigned char* out, int *outlen,
              const unsigned char* in, int *inlen) {
    unsigned char* outstart = out;
    const unsigned char* base = in;
...
isolat1ToUTF8(unsigned char* out, int *outlen,
              const unsigned char* in, int *inlen) {
  return _isolat1ToUTF8(out, outlen, in, inlen);
}
 ...
 */
static int
_UTF8Toisolat1(unsigned char* out, int *outlen,
              const unsigned char* in, int *inlen) {
    const unsigned char* processed = in;
    const unsigned char* outend;
    const unsigned char* outstart = out;
...
UTF8Toisolat1(unsigned char* out, int *outlen,
              const unsigned char* in, int *inlen) {
  return _UTF8Toisolat1(out, outlen, in, inlen);
}
#endif /* LIBXML_OUTPUT_ENABLED */
...
xmlInitCharEncodingHandlers(void) {
    ...
    xmlNewCharEncodingHandler("ISO-8859-1", _isolat1ToUTF8, _UTF8Toisolat1);
